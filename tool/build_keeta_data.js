...
// into the KeeTa-clone dataset schema (assets/data/keeta_data.json) so the KeeTa
...
//
// Run:  node tool/build_keeta_data.js   (from the project root)
//
// Keeps user/kingkong/filters/addresses/coupons/orders from the existing
// keeta_data.json; replaces shops + banners with real data.
...
const OUT = path.join(ROOT, 'assets', 'data', 'keeta_data.json');
