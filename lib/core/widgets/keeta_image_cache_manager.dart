...
/// can't leave a [KeetaImage] stuck on its placeholder forever.
...
/// Shared singleton disk cache for every [KeetaImage]. A 365-day stale window
...
class KeetaImageCacheManager {
  KeetaImageCacheManager._();

  static const String _key = 'keetaAppImageCache';
  ...
  static Future<void> clearCache() async {
    try {
      ...
      debugPrint('[KeetaImageCache] clear error: $e');
    }
  }
  ...
  static Future<void> removeFile(String keyOrUrl) async {
    try {
      ...
      debugPrint('[KeetaImageCache] remove error: $e');
    }
  }
  ...
  static Future<void> preCacheImages(
    ...
    Future<void> worker() async {
      while (queue.isNotEmpty) {
        ...
        } catch (_) {/* per-url failures non-fatal */}
      }
    }
  ...
  static Future<CacheInfo> getCacheInfo() async {
    try {
      ...
      debugPrint('[KeetaImageCache] info error: $e');
