...
/// Jameia `channel_list_main` — the channel / category landing list.
///
...
/// from [JameiaRepository.shops] via a [ListView.builder]. A scroll-to-top FAB
/// ("to-top" button) appears once the feed is scrolled; tapping a card opens
/// [Routes.shop].
class ChannelListPage extends StatelessWidget {
  const ChannelListPage({super.key, this.title = 'Discover'});
