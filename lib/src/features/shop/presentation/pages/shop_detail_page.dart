...
/// Jameia shop-detail panel: collapsing cover hero, info card (name / rating /
/// tags / description), delivery rows, opening hours, address + map placeholder,
/// and a sticky Favourite toggle.
class ShopDetailPage extends StatelessWidget {
  const ShopDetailPage({super.key, this.shopId = 's1'});
  final String shopId;
...
class _CoverHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      ...
      actions: [
        _CircleAction(icon: JameiaIcons.share, onTap: () {}),
        Padding(
        ...
        _CircleAction(icon: JameiaIcons.more, onTap: () {}),
    ...
    return _Card(
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () => context.push(Routes.shopMap, extra: shop.id),
            child: ClipRRect(
              borderRadius: BorderRadius.circular(AppRadius.r4),
              child: Stack(
                children: [
                  Image.asset(
                    JameiaAssets.userLocationIcon,
                    height: 140,
