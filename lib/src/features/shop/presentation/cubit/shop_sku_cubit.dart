...
/// the call site) instead of reaching into `core/data/jameia_repository.dart`, so
...
class ShopSkuCubit extends Cubit<ShopSkuState>
  ...
  static ShopSkuState _build(
    ...
    final vip = isVip;
    final ProductVariant? variant = product.hasVariants
    ...
    final canAdd = product.available && (variant == null || variant.inStock);
    return ShopSkuState(
