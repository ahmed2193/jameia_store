...
/// Real Jameia nav circle: 32×32dp, margin-left 16dp, margin-top 6dp (bb2fcb / ac5a43).
...
/// Hero cover image with the Jameia top/bottom gradient overlay. Full-width by
/// layout; height is fixed by the caller (a [SizedBox] of [kHeroCoverHeight] +
/// top inset), so [JameiaImage] discovers the painted box via [LayoutBuilder].
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        JameiaImage(url: coverUrl, height: kHeroCoverHeight, fit: BoxFit.cover),
        // gradient: real Jameia uses "linear-gradient(180deg, #F5F6FA 63%, #FFFFFF 100%)"
  ...
  Widget build(BuildContext context) {
    return SectionWrapper(
      ...
      child: Column(
        ...
        children: [
          // Shop name: Jameia-SemiBold 18dp #222222 (e7155c / jcf264 pattern)
          Text(
            shop.displayName,
            maxLines: 2,
...
class ShopCouponStrip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          const Icon(JameiaIcons.rank, size: 14, color: AppColors.skuOptionFg),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        NavCircle(
          child: Image.asset(JameiaAssets.shopSearch, width: 18, height: 18),
        ),
        NavCircle(
          child: Image.asset(JameiaAssets.shopShare, width: 18, height: 18),
        ),
        NavCircle(
          child: Image.asset(
