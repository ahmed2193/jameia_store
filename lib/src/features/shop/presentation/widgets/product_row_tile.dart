...
/// Real Jameia product row in shop menu — matches hc7f46 + b2bc0a atoms:
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Product name: Jameia-SemiBold 14dp #222222 (a4c6b3)
                    Text(
                      product.displayName,
                      maxLines: 1,
                    ...
                    // Description: Jameia-Regular 12dp #808080 — b8abe0 / e847da
              ...
              // JameiaImage wraps itself in a RepaintBoundary, so the image area
