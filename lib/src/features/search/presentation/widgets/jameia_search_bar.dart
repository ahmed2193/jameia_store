...
/// Jameia `c_search` top bar (first view + typing). Back chevron in a 40dp left
...
/// Jameia `c_search_shop` results bar: back chevron + a fully-rounded grey pill
...
/// entry screen for re-editing (matches Jameia).
