...
/// Jameia standalone full-screen order map (`mach_pro_sailor_c_order_map_golden`,
/// alias `c_order_map`).
///
...
/// polyline (`JameiaGeocode.routePolyline`, width 4), a floating ETA bubble, a
...
///
/// GESTURE-SAFE LAYOUT (RE §0.1, §8): the `JameiaMap` is sized to ONLY the region
...
class OrderMapPage extends StatelessWidget {
  const OrderMapPage({super.key, this.orderId = 'o1'});
