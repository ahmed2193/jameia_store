...
/// Jameia Orders list (`mach_pro_sailor_c_order_list`) — two tabs
/// (In progress / History) over [JameiaRepository.orders], per-order shop header,
...
/// - shop logo 40×40dp r13 | shop name Jameia-Bold 16dp #222222
/// - items Jameia-Regular 12dp #808080 | status chip r4.8dp padding 2×6dp
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            centerTitle: false,
            // Bundle: font-size 18dp Jameia-Medium (da93c4)
            title: Text(
              'orders.title'.tr(),
