...
class OrderCard extends StatelessWidget {
  ...
  void _openReview(BuildContext context) =>
      context.push(Routes.orderReview, extra: order.id);

  void _openRefundDetail(BuildContext context) =>
      context.push(Routes.orderRefundDetail, extra: order.id);

  void _openImChat(BuildContext context) =>
      context.push(Routes.imChat, extra: order.id);
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: () => order.isActive
              ...
              : context.push(Routes.shop, extra: order.shopId),
          child: Padding(
