...
class StatusHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Real Jameia (b31eae): headline Medium 18dp primaryText.
    // Real Jameia (ddaf19): sub-label Regular 12dp #4d4d4d ≈ secondaryText.
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: JameiaImage(url: order.shopLogo, fit: BoxFit.cover),
          ),
