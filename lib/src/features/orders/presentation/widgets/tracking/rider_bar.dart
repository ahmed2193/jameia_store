...
class RiderBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Real Jameia (acf275): avatar 40×40dp, radius=13dp, 1.5dp white border.
    ...
    return TrackingCard(
      child: Row(
        children: [
          ...
          RiderAction(
            icon: JameiaIcons.chat,
            badgeCount: 2,
            onTap: () => context.push(Routes.imChat),
          ),
          const SizedBox(width: AppSpacing.s8),
          RiderAction(icon: JameiaIcons.phone, onTap: () {}),
          // Bundle §2.3: rider action bar is call / IM / more (icon_rider_more).
          const SizedBox(width: AppSpacing.s8),
          RiderAction(
            icon: JameiaIcons.more,
