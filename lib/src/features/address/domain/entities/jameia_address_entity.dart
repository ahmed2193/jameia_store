...
///
/// Owned by the address feature (no reuse of the core `JameiaAddress` DTO, which
/// transitively pulls `google_maps_flutter` through `jameia_geocode`). Carries
/// every raw field the DTO does, but stores the Jameia enums as their raw INT /
...
class JameiaAddressEntity extends Equatable {
  ...
  // Jameia enums carried as their raw codes (framework-free).
