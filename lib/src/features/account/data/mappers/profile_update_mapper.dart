...
/// fields are sent; an empty email and a cleared gender go out as `null`.
extension ProfileUpdateMapper on ProfileUpdate {
  ...
  static const int _datePrefixLength = 10; // YYYY-MM-DD
  ...
  Map<String, Object?> toBody() => <String, Object?>{
    ...
    if (dateOfBirth != null)
      _dateOfBirthKey: dateOfBirth!.toIso8601String().substring(
        0,
        _datePrefixLength,
      ),
    if (gender != null)
      ...
      _genderKey: null,
    if (householdSize != null) _householdSizeKey: householdSize,
  };
}
