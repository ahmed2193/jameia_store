...
/// Jameia `mach_pro_sailor_c_mine_delivery_code` (Mine → Delivery code, v0.0.4) —
/// faithful 1:1 clone of the delivery-code editor.
///
/// Jameia renders `renderVerifyCode` / `code_edit` / `code_check_pass|error`
...
///
/// Sections (Jameia order): big delivery-code display, explanation copy ("give it
...
class _CodeDisplayCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          const Icon(JameiaIcons.delivery, size: 32, color: AppColors.primary),
