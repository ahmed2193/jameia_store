...
/// Cutlery row uses the real Jameia tableware icon asset + real switch images.
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            // Real Jameia switch asset (on / off)
            GestureDetector(
              onTap: () => onChanged(!value),
              child: Image.asset(
                value ? JameiaAssets.switchOn : JameiaAssets.switchOff,
                width: 48,
                height: 28,
