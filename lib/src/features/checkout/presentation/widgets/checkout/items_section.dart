...
/// Shop name + item rows. Jameia section-header style: 16dp/w500/#222222,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Section header — Jameia exact: pt:20dp, ph:16dp, mb:12dp, 16dp/w500
          ...
          Padding(
            ...
            child: Row(
              children: [
                JameiaImage.circle(url: shop.logo, size: 24),
