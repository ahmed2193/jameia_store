...
/// Jameia real drop-off tiles using bundle assets:
    ...
    Widget tile(DropOffOption value, String label, String sublabel) {
      ...
      return InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              // Real Jameia drop-off option image (selected/unselected)
              Image.asset(
                on
                    ? JameiaAssets.dropOffSelected
                    : JameiaAssets.dropOffUnselected,
                width: 40,
                height: 40,
