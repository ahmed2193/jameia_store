...
/// Jameia FAQ list / question-detail page — `mach_pro_sailor_c_customer_service_question`.
///
/// Faithful 1:1 clone of Jameia's self-serve help page (analysis 2.13). The live
...
/// fixed help topics from [JameiaRepository] via a page-scoped cubit, filters them
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: ContentClamp(
          child: Column(
            children: [
              // Search field (Jameia `customer-search` → `faqSearchKey`).
              _SearchField(
      ...
      builder: (context, current, _) {
        ...
        return DecoratedBox(
          ...
          child: Column(
            children: [
              PressScale(
                // Decorate the question header tap with Jameia's press feel; the
              ...
              // Answer body — Jameia's FAQ accordion (height + cross-fade),
