...
/// Jameia rider chat / IM screen — `im_user_rider_chat` (Mach bundle 64).
///
/// Faithful 1:1 clone of Jameia's in-order messaging surface:
...
///   • quick-reply chips — Jameia's canned-message row above the composer;
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<ImChatCubit, ImChatState>(
        ...
        // no longer reads `core/data/jameia_repository.dart`.
...
class _ChatBodyState extends State<_ChatBody> {
  ...
  /// Jameia canned quick replies shown above the composer.
