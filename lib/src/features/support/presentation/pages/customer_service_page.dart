...
/// Jameia customer-service help-center hub — `mach_pro_sailor_c_customer_service`.
///
/// Faithful 1:1 clone of Jameia's Help-center surface (per analysis 2.11): a
...
/// Interactive search entry — mirrors Jameia's `handleJumpToSearch`: the user
...
class _SearchHelpFieldState extends State<_SearchHelpField> {
  ...
  void _submit() {
    ...
    context.push(Routes.customerServiceQuestion, extra: q.isEmpty ? null : q);
  }
...
class _FaqRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PressScale(
      child: InkWell(
        onTap: () =>
            context.push(Routes.customerServiceQuestion, extra: question),
        child: Padding(
          padding: const EdgeInsetsDirectional.symmetric(
            horizontal: AppSpacing.s12,
...
class _HotlineCard extends StatelessWidget {
  ...
  /// Jameia `hotlinePhone` — wired to `callPhone` in the real page; here a
    ...
    return _SectionCard(
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              const Icon(JameiaIcons.phone, size: 20, color: AppColors.success),
              const SizedBox(width: AppSpacing.s10),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
