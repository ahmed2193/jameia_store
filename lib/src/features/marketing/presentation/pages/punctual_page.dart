...
/// Jameia on-time guarantee landing (`mach_pro_sailor_c_punctual`).
///
...
class PunctualPage extends StatelessWidget {
  const PunctualPage({super.key});
...
class _Hero extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          // Brand-yellow promise backdrop (Jameia `punctual-background`).
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        // Real Jameia punctual hero background (`punctual-background`); falls
        // back to the brand-green gradient when unavailable.
        Image.asset(
          JameiaAssets.punctualBackground,
          fit: BoxFit.cover,
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Image.asset(
                  // Real Jameia make-up-coupon graphic shipped with the punctual
                  // bundle (`promise_rule_coupon`).
                  JameiaAssets.punctualCoupon,
                  width: 30,
                  height: 30,
                  errorBuilder: (_, _, _) => const Icon(
                    JameiaIcons.deliveryTime,
    ...
    return SafeArea(
      child: Padding(
        ...
        child: AppButton(
          ...
          onPressed: () => context.push(Routes.punctualRule),
        ),
      ),
    );
  }
