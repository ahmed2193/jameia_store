...
// `core/data/jameia_repository.dart` — it routes through `CartCubit`.
...
///
/// Registered in the GoRouter config as `Routes.cartPreview`; callers open it
/// with `context.push(Routes.cartPreview)`.
...
class _CartBottomBar extends StatelessWidget {
  ...
  void _checkout(BuildContext context) {
    ...
    // repository. Keeps this screen off `core/data/jameia_repository.dart`.
    final shopId = context.read<CartCubit>().resolveCheckoutShopId();
    if (shopId == null) return;
    context.push(Routes.checkout, extra: shopId);
  }
