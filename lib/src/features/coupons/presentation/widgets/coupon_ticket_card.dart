...
/// Jameia coupon-ticket card: a left value block (amount + currency) joined to the
              ...
              ClipPath(
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    // (Jameia `coupon-rule-close` modal).
...
/// Jameia `coupon-rule` modal: title, key conditions (discount, min-spend,
          ...
          children: [
            Row(
              children: [
                ...
                IconButton(
                  icon: const Icon(JameiaIcons.close, size: 20),
                  color: AppColors.tertiaryText,
