...
/// Presentation-side, active-locale display for a [CouponEntity].
///
...
/// rebuild — matching the old `Coupon.displayTitle` getter behaviour exactly.
extension CouponDisplay on CouponEntity {
