...
/// Jameia home operation header as a COLLAPSING pinned [SliverAppBar].
///
...
Widget homeHeaderSliver({
  required JameiaAddress address,
        ...
        return Stack(
          ...
          children: [
            ...
            Opacity(
              opacity: t,
              child: Image.asset(
                JameiaAssets.homeHeaderDefaultBg,
                fit: BoxFit.cover,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Row(
        children: [
          Image.asset(
            JameiaAssets.addressLocationV3,
            width: 18,
            height: 18,
