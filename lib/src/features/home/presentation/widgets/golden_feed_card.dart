...
/// Jameia home feed "golden" shop card (`home_page_feeds_card_with_dishes_golden`
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: AspectRatio(
            aspectRatio: 1,
            child: JameiaImage(url: product.image, fit: BoxFit.cover),
          ),
        ),
        const SizedBox(height: 3),
        Text(
      ...
      child: InkWell(
        ...
        child: AspectRatio(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: [
              JameiaImage(url: shop.cover, fit: BoxFit.cover),
              const DecoratedBox(
                decoration: BoxDecoration(
