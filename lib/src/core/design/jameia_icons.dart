...
//
// Real Jameia icon glyphs resolved from the bundled `wm_c_iconfont.ttf`
// (cmap format 12 + post v2 glyph names) extracted from the decoded Jameia APK.
// Family is registered as 'JameiaIcon' in pubspec.yaml.
//
...
/// Icon constants over the real Jameia `wm_c_iconfont` ('JameiaIcon' family).
///
...
class JameiaIcons {
  ...
  static const String fontFamily = 'JameiaIcon';
  ...
  static const IconData storeLocation = IconData(
    0xe03d,
    fontFamily: fontFamily,
  );
  ...
  static const IconData contactMerchant = IconData(
    0xe00d,
    fontFamily: fontFamily,
  );
  ...
  static const IconData consultDoctor = IconData(
    0xe02b,
    fontFamily: fontFamily,
  );
  ...
  static const IconData arrowRightSmall = IconData(
    0xe042,
    fontFamily: fontFamily,
    matchTextDirection: true,
  );
  ...
  //                      JameiaAssets.mineScanQrCode for the Mine scan entry).
