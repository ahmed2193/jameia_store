...
export 'jameia_map_card.dart';

/// Single Google-Maps surface for the whole app (Jameia map screens: order
...
class JameiaMap extends StatelessWidget {
  const JameiaMap({
    super.key,
  ...
  /// Builds a marker from a REAL Jameia asset image (rider/shop/user PNG/WEBP).
  ...
  /// Builds a heading-rotated marker (rider) from a Jameia asset. The asset is
  ...
  Widget build(BuildContext context) {
    ...
    return GoogleMap(
      ...
      // Neutral Jameia-ish loading background while tiles fetch.
      style: null,
    );
  }
}
