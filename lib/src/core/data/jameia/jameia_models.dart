...
class JameiaCategory {
  ...
  List<Product> get allProducts => [for (final s in subs) ...s.allProducts];
}
...
/// Store settings relevant to the Jameia surfaces.
...
class JameiaCatalog {
  ...
  // Derived for the existing Jameia accessors (search / favorites / etc.).
