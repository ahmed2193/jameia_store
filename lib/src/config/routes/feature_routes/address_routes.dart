...
final List<RouteBase> addressRoutes = <RouteBase>[
  // Pops with the tapped JameiaAddress (select), or nothing on back.
  GoRoute(
  ...
  // extra: JameiaAddress to edit (default: null = new address). Pops with the
  // saved JameiaAddress.
  GoRoute(
    ...
    pageBuilder: (_, state) {
      ...
      return JameiaTransitionPage<Object?>(
        ...
        child: AddressEditPage(
          address: address is JameiaAddress ? address : null,
        ),
      );
    },
  ),
