...
/// KeeTa `c_search` typing-state suggestions. Rows are ≥51dp with a grey
        ...
        return Column(
          children: [
            PressScale(
              child: InkWell(
                onTap: () =>
                    onTap(isSearchFor ? term : suggestions[i]),
                child: Container(
...
class _SearchForText extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final base = AppTextStyles.headingMedium
        .copyWith(color: AppColors.black, fontWeight: AppTextStyles.regular);
    return Text.rich(
