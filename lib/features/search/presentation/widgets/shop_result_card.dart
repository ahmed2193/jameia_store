...
/// KeeTa `c_search_shop` result card — a shop header (logo · name · rating ·
...
class _InfoRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    const grey = TextStyle(fontSize: AppSize.font12, color: AppColors.labelGrey);
    if (pickup) {
      return Row(
        children: [
          const Icon(
...
// ── Rail product card (tap → open shop; no cart control per KeeTa) ────────────
