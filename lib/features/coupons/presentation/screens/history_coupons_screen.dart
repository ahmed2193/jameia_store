...
/// KeeTa **CouponEntity history** page
/// (`mach_pro_sailor_c_market_history_coupon_list`, bundle 25 — "Coupons —
/// history (used/expired/invalid)").
///
/// The history view is the read-only counterpart of [MyCouponsScreen]: a single
/// flat feed of the user's spent / lapsed coupons. It reuses the same
/// [CouponsCubit] (which already buckets `KeetaRepository.coupons` into
...
class HistoryCouponsScreen extends StatelessWidget {
  const HistoryCouponsScreen({super.key});
