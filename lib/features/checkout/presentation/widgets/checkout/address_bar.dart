...
/// Real KeeTa address section: location icon left, type badge (Home/Office/Other)
...
class AddressBar extends StatelessWidget {
  ...
  String _assetForLabel(String label) {
    switch (label.toLowerCase()) {
      case 'office':
        return KeetaAssets.iconOffice;
      case 'other':
        return KeetaAssets.iconOther;
      default:
        return KeetaAssets.iconHome; // 'Home' default
    }
  }
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            // Address-type icon from real KeeTa assets (32×32)
            Image.asset(
