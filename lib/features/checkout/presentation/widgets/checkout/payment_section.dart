...
/// Payment method picker — uses real KeeTa Apple Pay / Google Pay image assets;
  ...
  Widget build(BuildContext context) {
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              // KeeTa radio — b3caa4 (selected #000) / ieba4d (unselected #666):
    ...
    Widget payIcon(String asset, {double size = 28}) => Image.asset(
      ...
      errorBuilder: (context, error, stackTrace) =>
          const Icon(KeetaIcons.pay, size: 22, color: AppColors.secondaryText),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          tile(
            ...
            payIcon(KeetaAssets.applePay),
            'checkout.pay_apple'.tr(),
          ),
          const ThinDivider(indent: AppSpacing.s16),
          tile(
            PaymentMethod.googlePay,
            payIcon(KeetaAssets.googlePay),
