...
/// KeeTa `homepage_kingkong_page` (`category/kingKongPage`) — the category
...
/// the [ShopCard] feed pulled from [KeetaRepository.shops] via a
/// [ListView.builder]. A scroll-to-top FAB fades in once the feed is scrolled;
/// tapping a card opens [Routes.shop].
class KingKongLandingScreen extends StatelessWidget {
  const KingKongLandingScreen({
    super.key,
    this.categoryId = 'k1',
    this.title = 'Food',
  });
