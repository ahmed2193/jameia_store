...
/// longer imports `core/data/keeta_repository.dart` just for the constant.
const String kShopSupplierId = 'jameia';

/// KeeTa multi-SKU product-detail modal (`shop_multi_sku_modal_global`).
///
...
Future<void> showProductSku(
  ...
  // replacing the old `sl<KeetaRepository>().isVip` reach-in.
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          _StepBtn(
            asset: canDec ? KeetaAssets.skuDec : KeetaAssets.skuDecDisabled,
