...
/// Real KeeTa sticky cart bar — matches ecf4da / b5ceb4 / a7c4a7 atoms:
///   height 50dp, border-radius 16dp (r3), yellow primary bg when active,
///   #f0f1f5 smallBackground when inactive; KeeTa-Bold 16dp center-aligned.
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        // Subtotal price (KeeTa-SemiBold 16dp #222222)
        Expanded(
          child: Text(
        ...
        GestureDetector(
          onTap: () =>
              Navigator.pushNamed(context, Routes.checkout, arguments: shop.id),
          child: Container(
            ...
            child: Text(
              'shop.checkout'.tr(),
              // e19689 / e332cd: KeeTa-Medium 16dp #000000 center
              style: AppTextStyles.headingMedium.copyWith(
                fontWeight: AppTextStyles.bold,
                color: AppColors.brandForeground,
              ),
...
/// a7c4a7: height 50dp, padding 12dp, border-radius 16dp, #f0f1f5, KeeTa-Bold 16dp #222222.
