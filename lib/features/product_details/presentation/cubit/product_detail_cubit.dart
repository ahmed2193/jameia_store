...
class ProductDetailCubit extends Cubit<ProductDetailState>
  ...
  Future<void> load() async {
    ...
    result.fold(
      (failure) => safeEmit(state.copyWith(
          status: ProductDetailStatus.error, error: failure.message)),
      (detail) {
        _detail = detail;
  ...
  ProductDetailState _loadedState(
    ...
    return _derive(detail, vIndex, quantity,
  ...
  ProductDetailState _derive(
    ...
    final ProductVariant? variant =
        hero.hasVariants ? hero.variants[variantIndex] : null;
  ...
  void onVipModeChanged() {
    ...
    safeEmit(_derive(_detail!, state.variantIndex, state.quantity,
  ...
  void selectVariant(int index) {
    ...
    safeEmit(_derive(_detail!, index, state.quantity,
        imageIndex: state.imageIndex,
        showNutrition: state.showNutrition,
        satisfaction: state.satisfaction));
  }
  ...
  void setQuantity(int quantity) {
    ...
    safeEmit(_derive(_detail!, state.variantIndex, q,
        imageIndex: state.imageIndex,
        showNutrition: state.showNutrition,
        satisfaction: state.satisfaction));
  }
  ...
  void addToCart(CartCubit cart) {
    ...
    final vip = _storeMode.isVip;
    final variant =
        hero.hasVariants ? hero.variants[state.variantIndex] : null;
    cart.add(
      hero,
      kJameiaSupplierId,
      variant: variant,
