...
// home/shop/search push `ProductDetailScreen(product: <core Product>)`. Minting
...
class ProductDetail extends Equatable {
  ...
  List<Object?> get props =>
      [product.id, gallery, kcal, storage, weight, prepMinutes, brand, deals,
        similar, recipes, exploreMore];
}
...
class DealVM extends Equatable {
  ...
  @override
  List<Object?> get props =>
      [percent, title, titleAr, subtitle, subtitleAr, minSpend, deadline];
}
