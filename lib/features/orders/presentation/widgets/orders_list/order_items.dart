...
class OrderItems extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Bundle: db08ab — KeeTa-Regular 12dp #808080, max-lines 2, text-overflow ellipsis.
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: Text(
                    ...
                    style: AppTextStyles.bodySmall.copyWith(
                      // Bundle: KeeTa-Regular 12dp #808080
                ...
                // Bundle: qty badge right-aligned, KeeTa-Regular 12dp tertiaryText
                Text(
                  '×${item.qty}',
                  style: AppTextStyles.bodySmall.copyWith(
