...
class OrderPillButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // height 48dp, padding 13dp/32dp; font KeeTa-Bold 16dp w500 #222222.
    // Outline = white bg, border 1dp #00000014, same radius.
    final fg = filled ? AppColors.brandForeground : AppColors.primaryText;
    // KeeTa brand yellow #FFE41F — closest token to bundle's #FFEA00
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                label,
                // Bundle: e11e8a KeeTa-Bold w500 16dp #222222
