...
import 'keeta_popup_scaffold.dart';
...
class _PopupRouter extends StatelessWidget {
  ...
  void _cta(BuildContext context) {
    ...
    if (popup.scheme.isNotEmpty) {
      Navigator.pushNamed(context, Routes.shop, arguments: popup.scheme);
    }
  }

  @override
  Widget build(BuildContext context) {
    return KeetaPopupScaffold(
...
/// Pill CTA — 50dp h, r25, brand yellow, KeeTa-Bold 16dp (popup digest).
        ...
        child: Column(
          ...
          children: [
            ...
            if (popup.image.isNotEmpty)
              AspectRatio(
                aspectRatio: 327 / 120,
                child: KeetaImage(url: popup.image, fit: BoxFit.cover),
              ),
            Padding(
