...
class VipMartCard extends StatelessWidget {
  const VipMartCard({super.key, required this.onToggle, required this.settings});
              ...
              children: [
                ...
                Expanded(
                  child: _PromoCard(
                    ...
                    art: Image.asset(KeetaAssets.jameiaBag,
                ...
                Expanded(
                  child: _PromoCard(
                    ...
                    subtitle: 'home.minutes'.tr(namedArgs: {'minutes': '$minutes'}),
                    art: Image.asset(KeetaAssets.jameiaScooter,
                        fit: BoxFit.contain,
