...
///
/// keeta home is a ROOT shell tab, so — unlike jm3eia's pushed screen — there
/// is no leading back button. keeta pins `ThemeMode.light`, so the source's
...
Widget jameiaHomeHeaderSliver({
  required KeetaAddressEntity address,
...
class _JameiaHeroDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    final banner = context.locale.languageCode == 'ar'
        ? KeetaAssets.jameiaBannerAr
        : KeetaAssets.jameiaBannerEn;
              ...
              child: Padding(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    // Collapsed: compact search icon on the trailing edge.
                    Align(
...
/// + chevron, no pill background. Mirrors keeta's compact address group.
        ...
        child: Row(
          ...
          children: [
            ...
            const Icon(Icons.keyboard_arrow_down_rounded,
                color: kJameiaPillChevron, size: 18),
          ],
        ),
      ),
    );
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 4),
                const Icon(Icons.keyboard_arrow_down_rounded,
                    color: kJameiaPillChevron, size: 10),
              ],
            ),
          ),
        ),
          ...
          child: Row(
            children: [
              const Icon(Icons.search_rounded,
                  size: 16, color: kJameiaSearchHint),
              ...
              Expanded(
                child: Text(
                  ...
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: const TextStyle(fontSize: AppSize.font14, color: kJameiaSearchHint),
                ),
              ),
              const SizedBox(width: 8),
              SvgPicture.asset(
                KeetaAssets.jameiaScanLine,
                width: 16,
                height: 16,
