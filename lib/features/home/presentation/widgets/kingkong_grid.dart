...
/// KeeTa "KingKong" entry grid (`home_page_header_kingkong_sub`).
///
...
class KingKongGrid extends StatefulWidget {
  ...
  /// Closest real KeeTa iconfont glyph (used when an item has no image).
  static IconData iconFor(String name) => switch (name) {
    'restaurant' => KeetaIcons.flame,
    'shopping_basket' => KeetaIcons.cart,
    'local_pharmacy' => KeetaIcons.consultDoctor,
    'shopping_bag' => KeetaIcons.delivery,
    'set_meal' => KeetaIcons.product,
    'sell' => KeetaIcons.refund,
    'local_florist' => KeetaIcons.favorite,
    'grid_view' => KeetaIcons.more,
    _ => KeetaIcons.store,
  };
...
class _KingKongCell extends StatelessWidget {
  ...
  void _open(BuildContext context) {
    ...
    if (onTap != null) {
      ...
      Navigator.pushNamed(context, Routes.kingkongLanding, arguments: item);
    }
  }
