              ...
              return SizedBox(
                ...
                child: ListView.builder(
                  ...
                  padding: const EdgeInsetsDirectional.only(
                      start: AppSpacing.pageMargin, end: AppSpacing.s4),
...
class _PromoProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final priceColor = discounted ? AppColors.finalPrice : AppColors.primaryText;
              ...
              SizedBox(
                ...
                child: Stack(
                  children: [
                    ...
                    if (available)
                      _AddControl(product: product, vip: vip),
                  ],
                ),
              ),
...
class _AddControl extends StatelessWidget {
  ...
  void _add(BuildContext context) {
    ...
    quickAddToCart(context,
        product: product.toModel(), unitPrice: product.priceFor(vip));
  }
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text('home.percent_off'.tr(namedArgs: {'percent': '$percent'}),
