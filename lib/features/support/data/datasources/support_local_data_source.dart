...
/// Offline source for the customer-service help center. The live KeeTa page hits
/// `/api/order` + `/api/faq/faqList`; here the recent order comes from the
/// in-memory [KeetaRepository] and the FAQ script is fixed (KeeTa ships the same
/// help topics).
///
...
abstract class SupportLocalDataSource {
  ...
  /// screen — the presentation no longer reaches into [KeetaRepository].)
  Rider activeRider();
