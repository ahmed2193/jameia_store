...
/// [AddressLocalDataSource] (backed by [KeetaRepository]) and wraps the result in
/// `Either<Failure, T>`.
///
/// The mutations forward to the SAME `KeetaRepository` operations the cubits used
...
class AddressRepositoryImpl implements AddressRepository {
  ...
  Future<Either<Failure, List<KeetaAddressEntity>>> getAddresses() async {
    try {
      // Hoist the default address to the top to mirror KeeTa's ordering.
